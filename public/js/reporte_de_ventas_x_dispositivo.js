...
$(document).on('click', '#resumen_de_ventas_x_dispositivo', async function() {
...
async function montar_tabla(){
    ...
    let grupo = $('#grupo_agencias').selectpicker('val');
    ...
    data = {"c0":"todos","receptor":receptores,"grupo_agencias":grupo,"f1":f1,"f2":f2,"comando":"resumen_de_ventas_x_dispositivo"};
