...
$(document).on('click','td',async function(){
    ...
    let grupo= $('#tabla_'+moneda_actual).DataTable().row(currentRow).data()[1];
    if(column=="0"){
        Swal.fire({
            title: 'Eliminar Grupo',
            text: "¿Esta seguro que desea eliminar este grupo?",
            icon: 'warning',
            ...
            if (result.isConfirmed) {
                let data = {"comando":"cfg_zonas_eli","c0":grupo}
...
$(document).on("click","#agregar_zona", function(){
