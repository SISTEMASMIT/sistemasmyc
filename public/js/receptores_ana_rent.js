...
$(document).on('click', '#receptores_analisis_de_rentabilidad', async function () {
...
async function montar_tabla() {
    ...
    data = { "receptor": receptores, "orden": orden, "f1": f1, "f2": f2, "comando": "receptores_analisis_de_rentabilidad" };

    var info = await ajax_peticion("/query/standard_query", { 'data': JSON.stringify(data) }, "POST");
    data_actual = info.data.data;
    ...
    let labels = { "Receptor": receptores, "Orden": orden, "Fecha Inicial": f1V, "Fecha Final": f2V };
