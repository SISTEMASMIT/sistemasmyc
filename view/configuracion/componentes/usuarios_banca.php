                            ...
                            <form id="formUsuarios">
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <button type="button" class="btn btn-primary btn-lg w-100 waves-effect waves-light">Super usuario</button>
                                            </div>
                                        </div>
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                <button type="button" class="btn btn-warning btn-lg w-100 waves-effect waves-light">Loterias</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
