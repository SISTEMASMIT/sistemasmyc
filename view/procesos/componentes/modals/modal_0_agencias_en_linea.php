<div class="modal fade" id="dispositivos" tabindex="-1" aria-labelledby="exampleModalLabel" style="display: none;" aria-hidden="true">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table id="tabla2" class="cell-border display nowrap invisible" style="width:100%" >
                    <thead class="thead" style="width: 0px;margin-left: 0px; width: 52em;" id="thead2">
                        <tr>
                            <th></th>
                        </tr>
                    </thead>
